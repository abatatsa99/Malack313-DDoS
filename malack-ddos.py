    ...
    def attack():
        ...
        while True:
            try:
                ...
                attack_num += 1
                print(f"{Fore.LIGHTMAGENTA_EX}[]  {Fore.LIGHTCYAN_EX}M A L A C K \033[103mSent massage\033[0m  \033[41m"+ str(attack_num)+" \033[33m running..\033[0m")
                print(f"{Fore.LIGHTRED_EX}[]  {Fore.LIGHTYELLOW_EX}M A L A C K \033[7mSent massage\033[0m  \033[103m"+ str(attack_num)+" \033[31m running..\033[0m")
            except socket.error:
